...
(function () {
    ...
    function injectRuntimeStyle() {
        ...
        style.textContent = [
            ...
            '#page-header #post-info > *::before,',
            '#post > #post-info::before {',
            '  background-image: repeating-linear-gradient(180deg, rgba(141, 210, 255, 0.32) 0 1px, rgba(141, 210, 255, 0) 1px 12px);',
            '  animation: post-info-line-wave-a 6s ease-in-out infinite;',
            '}',
            '#page-header #post-info > *::after,',
            '#post > #post-info::after {',
            '  background-image: repeating-linear-gradient(180deg, rgba(255, 255, 255, 0.26) 0 1px, rgba(255, 255, 255, 0) 1px 16px);',
            '  animation: post-info-line-wave-b 9s ease-in-out infinite;',
            '}',
            '#page-header #post-info > * > *,',
            '#post > #post-info > * {',
            '  position: relative;',
            '  z-index: 1;',
            '}',
            '@keyframes post-info-line-wave-a {',
            '  0% { transform: translateY(0) skewX(0deg); }',
            '  25% { transform: translateY(-3px) skewX(1.2deg); }',
            '  50% { transform: translateY(2px) skewX(-1.1deg); }',
            '  75% { transform: translateY(-2px) skewX(0.9deg); }',
            '  100% { transform: translateY(0) skewX(0deg); }',
            '}',
            '@keyframes post-info-line-wave-b {',
            '  0% { transform: translateY(0) skewX(0deg); }',
            '  25% { transform: translateY(2px) skewX(-0.8deg); }',
