...
(function () {
    ...
    function injectRuntimeStyle() {
        ...
        style.textContent = [
            ...
            '#post > #post-info::before {',
            '  bottom: -30%;',
            '  background: radial-gradient(ellipse at center, rgba(120, 195, 255, 0.22) 0%, rgba(120, 195, 255, 0) 70%);',
            '  animation: post-info-wave-a 8s ease-in-out infinite;',
            '}',
            '#page-header #post-info::after,',
            '#post > #post-info::after {',
            '  bottom: -36%;',
            '  background: radial-gradient(ellipse at center, rgba(255, 255, 255, 0.25) 0%, rgba(255, 255, 255, 0) 72%);',
            '  animation: post-info-wave-b 11s ease-in-out infinite;',
            '}',
            '#page-header #post-info > *,',
            '#post > #post-info > * {',
            '  position: relative;',
            '  z-index: 1;',
            '}',
            '@keyframes post-info-wave-a {',
            '  0% { transform: translateX(-8%) translateY(2%) scale(1); }',
            '  50% { transform: translateX(8%) translateY(-3%) scale(1.06); }',
            '  100% { transform: translateX(-8%) translateY(2%) scale(1); }',
            '}',
            '@keyframes post-info-wave-b {',
            '  0% { transform: translateX(10%) translateY(1%) scale(1.02); }',
            '  50% { transform: translateX(-10%) translateY(-4%) scale(1.08); }',
            '  100% { transform: translateX(10%) translateY(1%) scale(1.02); }',
            '}',
